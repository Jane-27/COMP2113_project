...
void zuma_main(int &point) {
  ...
  Ball *head = NULL;
  int numball;
  cout << "How many balls would you want on the table, you should input a number lager than 5" << endl;
  cin >> numball;

  while(numball<5)
  {cout<<"You should input a number larger than 5"<<endl;
  cin >> numball;
  }
  ...
  char ifstart;
  cout << "Input Y to start the game ";
  cin >> ifstart;
  ...
  point = numball*5 + (numball/numinsert*10) - timeused;
